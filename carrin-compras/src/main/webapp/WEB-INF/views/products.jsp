			...
			<form method="POST" action="inseriProduto" enctype="multipart/form-data">
				<section class="form-group">
					<label>Nome do produto: 
						<input required type="text" name = "nm_produto" class="form-control" value="${produto.getNm_produto()}" />	
					</label>	
				</section>
				<section class="form-group">
					<label>Valor do produto: 
					    <input type="number" step=".01"  name = "valor_produto" class="form-control"  placeholder="0.00" 
